        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventModel>().HasData(
                new EventModel()
                {
                    ...
                    TicketPrice = 399,
                    EventDate = new DateTime(2023, 05, 15, 08, 00, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 550,
                    EventDate = new DateTime(2023, 02, 19, 20, 30, 0, DateTimeKind.Local),
                    TicketsRemaining = 85,
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 100,
                    EventDate = new DateTime(2023, 07, 20, 16, 00, 0, DateTimeKind.Local),
                    TicketsRemaining = 40,
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 70,
                    EventDate = new DateTime(2023, 04, 28, 17, 30, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 75,
                    EventDate = new DateTime(2023, 05, 06, 12, 45, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 475,
                    EventDate = new DateTime(2023, 08, 27, 19, 00, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 1475,
                    EventDate = new DateTime(2023, 03, 10, 21, 30, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 399,
                    EventDate = new DateTime(2023, 05, 19, 20, 25, 0, DateTimeKind.Local),
                    TicketsRemaining = 20,
                ...
                new EventModel()
                {
                    ...
                    Description = "A music festival featuring electronic dance music (EDM) acts, carnival rides, and immersive art installations.",
                    TicketPrice = 0,
                    EventDate = new DateTime(2023, 09, 16, 22, 30, 0, DateTimeKind.Local),
                    TicketsRemaining = 0,
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 0,
                    EventDate = new DateTime(2023, 06, 24, 13, 40, 0, DateTimeKind.Local),
                    TicketsRemaining = 0,
                    ImageUrl = "TDF.jpg"
                },
                new EventModel()
                {
                    ...
                    TicketPrice = 80,
                    EventDate = new DateTime(2023, 04, 6, 08, 00, 0, DateTimeKind.Local),
                    TicketsRemaining = 65,
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 270,
                    EventDate = new DateTime(2023, 05, 13, 15, 00, 0, DateTimeKind.Local),
                    TicketsRemaining = 150,
                    ImageUrl = "Venice.jpg"
                },
                new EventModel()
                {
                    ...
                    TicketPrice = 500,
                    EventDate = new DateTime(2023, 06, 26, 17, 45, 0, DateTimeKind.Local),
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 350,
                    EventDate = new DateTime(2023, 03, 24, 20, 20, 0, DateTimeKind.Local),
                    TicketsRemaining = 130,
                ...
                new EventModel()
                {
                    ...
                    TicketPrice = 650,
                    EventDate = new DateTime(2023, 06, 17, 15, 30, 0, DateTimeKind.Local),
                    TicketsRemaining = 60,
